...
public:
  ...
  T &get(size_t i, size_t j) { return this->data.at(this->m * i + j); }

  T &operator[](size_t i, size_t j) { return this->get(i, j); }

  void set(size_t i, size_t j, T value) { this->get(i, j) = value; }
